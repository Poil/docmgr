...
function leftColumnDisplay($optionArray) {
	...
	$string .= "<div class=\"leftColumnTop\">&nbsp;</div>\n";

	$string .= "<div class=\"leftColumnBody\">\n";
	if (!$optionArray["hideHeader"]) $string .= "<div class=\"leftColumnHeader\">".$optionArray["leftHeader"]."</div>";

	$string .= "<div class=\"leftColumnContent\">".$optionArray["content"]."</div>";

	$string .= "</div>\n";

	$string .= "<div class=\"leftColumnBottom\">&nbsp;</div>\n";
	$string .= "</div>\n";
