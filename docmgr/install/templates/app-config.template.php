...
$template = array();
$template["Apps"] = array();
$template["Apps"]["APP_PYTHON"] = array("/opt/openoffice.org3/program/python",true,"Path to python binary with UNO bindings (usually in OpenOffice program directory)",false,true);
...
$template["Apps"]["APP_PDFTOTEXT"] = array("pdftotext -nopgbrk -q",true,"Do not remove the -nopgbrk option",false,true);
...
$template["Apps"]["APP_GS"] = array("gs",true,"Ghostscript",false,true);
$template["Apps"]["APP_PDFTOPPM"] = array("pdftoppm",true,"pdftoppm",false,true);
